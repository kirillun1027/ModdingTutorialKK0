...
import net.kirillun1027.tutorialmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.PINK_GEM_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 10, 2, false, false),
                                    new StatusEffectInstance(StatusEffects.RESISTANCE, 10, 1, false, false)
                            )).build();
